...
document.querySelector('.no-go').textContent = `${S.decision} · ${S.evidenceLabel}: implementation ${S.commits.implementation}; docs ${S.commits.docs}; Nix full ${E.nixFull.passed}/${E.nixFull.failed}; disposable PostgreSQL ${E.disposablePostgresqlFull.passed}/${E.disposablePostgresqlFull.failed}; targeted P4 ${E.targetedP4.passed}/${E.targetedP4.failed}; labels ${E.labels.passed}/${E.labels.total}.`;
document.querySelector('.evidence-note').innerHTML = `<h2>Current facts</h2><ul><li>Implementation ${S.commits.implementation}; docs ${S.commits.docs}; pinned reviewed evidence.</li><li>Nix full: ${E.nixFull.passed}/${E.nixFull.failed}; disposable PostgreSQL: ${E.disposablePostgresqlFull.passed}/${E.disposablePostgresqlFull.failed}; targeted P4: ${E.targetedP4.passed}/${E.targetedP4.failed}; labels: ${E.labels.passed}/${E.labels.total}.</li><li>Yellow live provider gap: approved non-production configuration, endpoints, and credentials absent.</li><li>Red production qualification: live provider, deployment, recovery, load/SLO, RPO/RTO, and approval evidence absent.</li><li><strong>Exactly one next roadmap item:</strong> ${S.next}</li></ul>`;
const items = [
