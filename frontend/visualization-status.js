...
window.VISUALIZATION_STATUS = Object.freeze({
  snapshot: 'Committed frontend evidence · 1656b0e · 2026-08-15',
  commits: { implementation: '1656b0e', docs: '397911e', history: ['9be2d0b', '6a6f868'] },
  evidenceScope: 'Committed frontend state 1656b0e; BDD/evidence metadata committed in 397911e; prior recorded run dated 2026-08-15; development/mock scope only',
  ledgerPolicy: 'Ledger commit identifies HEAD at evidence capture; dirty-uncommitted marks worktree state. This view claims prior recorded evidence only and never treats uncommitted changes as evidence.',
  ...
  limitations: ['Development/mock/reference only', 'No live provider calls', 'No production qualification', 'Prior recorded run only; no new test evidence claimed', 'Ledger captured dirty-uncommitted worktree; uncommitted changes excluded'],
  ...
  evidence: ['Committed frontend: 1656b0e', 'BDD/evidence metadata: 397911e', 'History: 9be2d0b, 6a6f868', 'Prior recorded test run (2026-08-15) — Nix full: 200 passed / 0 failed', 'Prior recorded test run (2026-08-15) — Disposable PostgreSQL: 200 passed / 0 failed', 'Prior recorded test run (2026-08-15) — Targeted P4: 14 passed / 0 failed', 'Prior recorded test run (2026-08-15) — Labeled scenarios: 21/21', 'Development/mock/reference only; production_qualification=false; no new test evidence claimed; uncommitted changes excluded'],
