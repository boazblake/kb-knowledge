    ...
    in {
      devShells = forAllSystems (system:
        let
          ...
          runtimeInputs = [ pkgs.python311 pkgs.python311Packages.boto3 pkgs.python311Packages.cryptography pkgs.nodejs_22 pkgs.sqlite pkgs.git pkgs.jq pkgs.coreutils ];
        in {
      ...
      checks = forAllSystems (system:
        let
          pkgs = import nixpkgs { inherit system; };
          runtimeInputs = [ pkgs.python311 pkgs.nodejs_22 pkgs.sqlite pkgs.git pkgs.jq pkgs.coreutils ];
        in {
